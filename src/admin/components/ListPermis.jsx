    ...
    <>
       <div className="container-fluid">
                    ...
                    <div className="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 className="h3 mb-0 text-gray-800">Permisos</h1>
                        <a href="crear-pro.html" className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            <i className="fas fa-plus fa-sm text-white-50"></i> Crear Permisos</a>
                    </div>
                    ...
                    <div className="row">
                         ...
                         <div className="input-group mb-3 rounded-pill overflow-hidden border w-50">
                            ...
                            <input type="search" className="form-control hide-focus border-0" placeholder="Buscar Permisos" aria-label="Username" aria-describedby="basic-addon1"/>
                          </div> 
